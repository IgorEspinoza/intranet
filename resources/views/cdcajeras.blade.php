...
<body class="p-3 m-1 border-1 bd-example">
  ...
  <div class="justify-content-center col-md-3 p-1 border-2">
    <select class="form-select" aria-label="select-capacitaciones">
      ...
      <option value="4">Atencion a publico</option>
      <option value="5">TMERT</option><!--trastornos musculoesqueleticos relacionados con el trabajo-->
    </select>
  </div>
  <!--document upload-->
