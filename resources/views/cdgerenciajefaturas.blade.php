...
<head>
  ...
  <title>CD Gerencia y Jefaturas</title>
...
<body class="p-3 m-1 border-1 bd-example">
  ...
  <div class="titulos">
    ...
    <h3>
      <center>Gerencia y Jefaturas</center>
    </h3>
  </div>
  ...
  <div class="justify-content-center col-md-3 p-1 border-2">
    <select class="form-select" aria-label="select-capacitaciones">
      ...
      <option value="4">Taller de responsabilidad civil y penal</option>
      <option value="5">Investigacion de accidentes</option>
      <option value="6">Liderazgo y comunicacion en la administracion de riesgos</option>
      <option value="7">Identificacion de peligros y evaluaciones de riesgo</option>
      <option value="8">Prevencion del coronavirus</option>
    </select>
  </div>
  <!--document upload-->
